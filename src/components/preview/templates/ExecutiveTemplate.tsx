        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-sm text-white/90">
            ...
            {personalInfo.linkedin && (
              <span className="flex items-center gap-2"><Linkedin className="w-4 h-4 opacity-70" /> {personalInfo.linkedin.replace(/^https?:\/\//, '')}</span>
            )}
            {personalInfo.github && (
              <span className="flex items-center gap-2"><Github className="w-4 h-4 opacity-70" /> {personalInfo.github.replace(/^https?:\/\//, '')}</span>
            )}
            {personalInfo.portfolio && (
              <span className="flex items-center gap-2"><Globe className="w-4 h-4 opacity-70" /> {personalInfo.portfolio.replace(/^https?:\/\//, '')}</span>
            )}
